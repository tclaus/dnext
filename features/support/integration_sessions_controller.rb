...
class IntegrationSessionsController < ApplicationController
  # This is used for automatic login. The path to this template is longer than the template itself,
  # so in this case an inline template is the better solution
  # rubocop:disable Rails/RenderInline
  def new
    @user_id = params[:user_id]
    render inline: '= button_to "Login", integration_sessions_path(user_id: @user_id)', type: :haml, layout: false
  end
