...
# require all files under 'shared_behaviours'
Dir["#{File.dirname(__FILE__)}/shared_behaviors/**/*.rb"].each do |shared_behavior_spec|
  require shared_behavior_spec
end

# require all files under 'support'
Dir["#{File.dirname(__FILE__)}/support/**/*.rb"].each do |support_files|
  require support_files
end

RSpec::Matchers.define_negated_matcher :remain, :change

# TODO: Class Uploaders still missing, build a new one with rails 7 techniqus?
